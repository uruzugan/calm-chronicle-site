...
const faqs = [
  ...
  {
    q: "制作期間はどのくらいかかりますか？",
    a: "初稿は受付当日〜翌営業日にご提出します。修正回数によって最短2営業日〜最長4週間程度で公開となります（修正なしの場合が最短）。",
  },
  {
    q: "修正回数を超えた場合はどうなりますか？",
    a: "修正回数を超えた場合は、1回あたり8,800円（税込）の追加費用が発生します。",
  },
];
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  {[
                    ...
                    ["月額費用", "19,800円〜（税抜）", "別途更新費用", "1,000〜5,000円"],
                    ["制作期間", "最短2営業日〜最長4週間程度", "1〜3ヶ月", "自分次第"],
